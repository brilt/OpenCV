...
def object_detection():
    ...
    while True:
        ...
        # apply object detection algorithm to the frame
        # ...your object detection code goes here...

        # check if the frame is not empty before encoding it
        if ret:
            image = frame
            ...
            for detection in output[0, 0, :, :]:
                ...
                if confidence > .4:
                    ...
                    # put the class name text along with confidence on the detected object
        ...
        # check if the encoding was successful before yielding the frame
        if not ret:
            continue
